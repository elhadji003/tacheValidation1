        ...
        <form action="{{ route('taches.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description" rows="4"
                    class="peer block w-full px-2.5 pb-2.5 pt-2 text-sm text-gray-900 bg-transparent border-2 border-gray-300 rounded-lg appearance-none focus:outline-none">{{ old('description') }}</textarea>
            </div>
            ...
            <div class="mb-4">
                <label for="is_complete" class="inline-flex items-center">
                    <input type="checkbox" name="is_complete" id="is_complete" class="form-checkbox text-blue-500"
                        value="1" {{ old('is_complete') ? 'checked' : '' }}>
            ...
            <div class="flex items-center justify-between">
                ...
                <button type="submit" class="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">Créer la
                    Tâche</button>
            </div>
        </form>
    </div>
